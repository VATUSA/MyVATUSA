<template>
  <div>
                ...
                <tr v-for="(roster, idx) in filteredRoster" :key="idx" class="bg-white border-b">
                  ...
                  <td class="px-6 py-1">
                    <button
                      ...
                      @click="openEditUserModal(roster)"
                    >
                      Edit
                    </button>
                  </td>
    ...
    <Modal
      :title="`${selectedUser?.first_name} ${selectedUser?.last_name} - ${selectedUser?.cid}`"
      subtitle="VATUSA User Information"
      :visible="editUserModalVisible"
      @close="closeEditUserModal"
    >
      <EditUser :roster="selectedUser" />
    </Modal>
  </div>
</template>
...
const selectedUser = ref<Roster | null>(null);
const openEditUserModal = (ros: Roster): void => {
  selectedUser.value = ros;
